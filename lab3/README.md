присутствуя на воркшопе, не особо записывал ход работы, но сделал несколько скринов в процессе и выполнил все указанные шаги со инструкции приложенной ниже
